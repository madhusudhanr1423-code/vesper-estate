...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Vesper Estates — Architectural Residences & Private Estates" },
      {
        name: "description",
        content:
          "Vesper Estates curates a discreet portfolio of architectural residences, private estates and coastal retreats for a global clientele.",
      },
      { name: "author", content: "Vesper Estates" },
      { property: "og:title", content: "Vesper Estates — Architectural Residences & Private Estates" },
      {
    ...
    links: [
      ...
      { rel: "icon", href: "/favicon3.png", type: "image/png" },
